            ...
            <div id="education">
                <div className="py-5 px-6 text-sm sm:text-base md:text-md lg:text-lg xl:text-xl border-b border-gray-300">
                    <div className="container mx-auto text-gray-600 lg:px-8 text-center lg:text-left">
                        ...
                        <p>
                            Throughout the years, I have gained valuable knowledge and experiences that have shaped both my academic and personal development.
                        </p>
                        <p>
                            Below are the details of my educational background.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="container mx-auto text-gray-600 lg:px-8 flex flex-col gap-5">
                        {EducationList.map((items, index) => (
                             <div key={index} class="flex gap-4">
                                ...
                                <div class="bg-white border border-gray-300 p-4 rounded-lg flex-1 flex gap-3 flex-col items-center sm:flex-row md:flex-row lg:flex-row">
